...
`united-software-platform/prompt-store` — коллекция промптов и правил для AI-ассистентов в разработке ПО.

**Важно:** репозиторий содержит только текстовые файлы (Markdown). Кода, тестов и инструментов статического анализа в нём нет и быть не должно.
...
- Исходный код, тесты, бинарные файлы, `node_modules/`, `vendor/`
